...
public class MemberApi {
	...
	// @ResponseBody
	// public String createMember(@RequestBody Member member) throws
	...
	// "application/json; charset=utf-8" })
	// @ResponseBody
	// public String updateMember(@PathVariable("id") int id, @RequestBody Member
	// member) throws JsonProcessingException {
	// logger.debug(member.toString());
	//
	...
	// "application/json; charset=utf-8" })
	// @ResponseBody
	// public String deleteMember(@PathVariable("id") int id) throws
	// JsonProcessingException {
	//
